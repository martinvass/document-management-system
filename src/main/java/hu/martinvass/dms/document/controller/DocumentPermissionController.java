...
public class DocumentPermissionController {
    ...
    public String addDepartment(
        ...
        try {
            var document = documentService.getDocument(docId, profile);
            permissionService.checkPermission(document, profile, DocumentPermissionLevel.ADMIN);

            var department = departmentService.getDepartment(departmentId, profile.getCorporation());
    ...
    public String grantUserPermission(
        ...
        try {
            var document = documentService.getDocument(docId, profile);
            var targetProfile = profileRepository.findById(profileId)
            ...
            var level = DocumentPermissionLevel.valueOf(permissionLevel);
